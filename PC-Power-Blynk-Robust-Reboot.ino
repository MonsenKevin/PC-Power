...
// --- CLOUD TRIGGER: STATUS CHECK (Virtual Pin V3) ---
// Apple Shortcut URL: https://blynk.cloud/external/api/get?token=YOUR_AUTH_TOKEN&v3
BLYNK_WRITE(V3) { 
  int pinValue = param.asInt();
  Serial.println("Switching Status...");
  if (pinValue == 0) {
